...
export const pageQuery = graphql`
  {
    ...
    mdx(fields: {slug: {eq: "/tokens/overview/"}}) {
      fileAbsolutePath
      frontmatter {
        slug
        title
...
<DoDont>
  ...
  <Dont title="Don't" body="Name a token based on its value." center>
...
Example: <Text fontFamily="fontFamilyCode" display='inline'>$<strong>color</strong>-background-primary</Text>

### Category

Categories are the UI entities the token will be applied to, such as background, border, radius, font-size.

Example: <Text fontFamily="fontFamilyCode" display='inline'>$color-<strong>background</strong>-primary</Text>
...
Example: <Text fontFamily="fontFamilyCode" display='inline'>$color-background-<strong>success</strong></Text>

### Variant

The variant of an instance token, such as weak, weakest, strong, stronger.

Example: <Text fontFamily="fontFamilyCode" display='inline'>$color-border-success-<strong>stronger</strong></Text>

### State

State in which the token should be used, such as hover, focus, selected.

Example: <Text fontFamily="fontFamilyCode" display='inline'>$shadow-box-shadow-<strong>focus</strong></Text>
