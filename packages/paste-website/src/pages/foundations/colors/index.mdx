...
[View all background color tokens](/tokens/#background-colors)
...
[View all text and icon color tokens](/tokens/#text-colors)
...
[View all border color tokens](/tokens/#border-colors)
